...
// Remove any entry you don't use
// ──────────────────────────────────────────────
const socials = [
  {
    name: "Facebook",
    href: "https://facebook.com/buzzalarmas", // ← replace with your Facebook URL
    icon: (
  ...
  {
    name: "Instagram",
    href: "https://instagram.com/buzzalarmas", // ← replace with your Instagram URL
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: "LinkedIn",
    href: "https://linkedin.com/company/buzzalarmas", // ← replace with your LinkedIn URL
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="border-t border-white/5 pt-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-white/25">
          ...
          <div className="flex items-center gap-4">
            ...
            <span>·</span>
            <a href="/terms-and-conditions" className="hover:text-orange transition-colors">
              {t("footer.terms")}
            </a>
          </div>
        </div>
